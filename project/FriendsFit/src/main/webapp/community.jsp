	...
	<div id="whole">
		<div id="mainframe">
			<div id="main-content">
				...
				<div data-testid="category-list"
					...
					<div role="listitem"
						...
						<div
							...
							<img src="img/fitness.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
					...
					<div role="listitem"
						...
						<div
							class="CommunityListTemplate__StyledCategoryItemIconWrapper-sc-1n95qdm-1 eEEovz">
							<img src="img/swim.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
								<g clip-path="url(#clip0_2959_48320)">
								<path
					...
					<div role="listitem"
						...
						<div
							class="CommunityListTemplate__StyledCategoryItemIconWrapper-sc-1n95qdm-1 eEEovz">
							<img src="img/flexibility.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
								<g clip-path="url(#clip0_2959_48323)">
								<path
					...
					<div role="listitem"
						...
						<div
							class="CommunityListTemplate__StyledCategoryItemIconWrapper-sc-1n95qdm-1 eEEovz">
							<img src="img/crossfit.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
								<g clip-path="url(#clip0_6987_62630)">
								<g clip-path="url(#clip1_6987_62630)">
								<path
								...
								<path
									...
									fill="#A6DEC5"></path>
								<path d="M18.2268 15.3H13.7734V18.6667H18.2268V15.3Z"
									fill="#FFDBC7"></path>
								<path
								...
								<defs>
								<clipPath id="clip0_6987_62630">
								<rect width="32" height="32" fill="white"></rect></clipPath>
								<clipPath id="clip1_6987_62630">
					...
					<div role="listitem"
						...
						<div
							class="CommunityListTemplate__StyledCategoryItemIconWrapper-sc-1n95qdm-1 eEEovz">
							<img src="img/racket.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
								<g clip-path="url(#clip0_6987_62638)">
								<g clip-path="url(#clip1_6987_62638)">
								<path
								...
								<defs>
								<clipPath id="clip0_6987_62638">
								<rect width="32" height="32" fill="white"></rect></clipPath>
								<clipPath id="clip1_6987_62638">
								<rect width="32" height="32" fill="white"></rect></clipPath></defs></svg>
						</div>
						<p
					...
					<div role="listitem"
						...
						<div
							class="CommunityListTemplate__StyledCategoryItemIconWrapper-sc-1n95qdm-1 eEEovz">
							<img src="img/climb.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
								<g clip-path="url(#clip0_6987_62642)">
								<g clip-path="url(#clip1_6987_62642)">
								<path
								...
								<defs>
								<clipPath id="clip0_6987_62642">
								<rect width="32" height="32" fill="white"></rect></clipPath>
								<clipPath id="clip1_6987_62642">
								<rect width="32" height="32" fill="white"></rect></clipPath></defs></svg>
						</div>
						<p
					...
					<div role="listitem"
						...
						<div
							class="CommunityListTemplate__StyledCategoryItemIconWrapper-sc-1n95qdm-1 eEEovz">
							<img src="img/mudo.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
								<path
					...
					<div role="listitem"
						...
						<div
							class="CommunityListTemplate__StyledCategoryItemIconWrapper-sc-1n95qdm-1 eEEovz">
							<img src="img/golf.png" width="36" height="36" viewBox="0 0 32 32" fill="none">
								<g clip-path="url(#clip0_6987_62646)">
								<g clip-path="url(#clip1_6987_62646)">
								<path
								...
								<path
									...
									fill="#FFDA82"></path></g></g>
								<defs>
								<clipPath id="clip0_6987_62646">
								<rect width="32" height="32" fill="white"></rect></clipPath>
								<clipPath id="clip1_6987_62646">
								<rect width="32" height="32" fill="white"></rect></clipPath></defs></svg>
						</div>
						<p
				...
				<div id="wrap">
					<div id="container" style="min-height: 955px;">
						<div id="contents">
							<div class="contents_inner">
								...
								<div
									...
									<a href="communityWrite.jsp">Write</a>
								</div>
								...
								<div
									...
									<ol style="padding: 0;">
										...
										<li class="xans-record-"><a href="" class="other">2</a></li>
										<li class="xans-record-"><a href="" class="other">3</a></li>
										<li class="xans-record-"><a href="" class="other">4</a></li>
										<li class="xans-record-"><a href="" class="other">5</a></li>
									</ol>
									<p class="next">
										<a href="?board_no=4&amp;page=2"><span>NEXT</span></a>
									</p>
								</div>
